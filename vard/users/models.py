...
class Access(models.Model):
    user_id = models.ForeignKey(
        to="User", on_delete=models.CASCADE, related_name="access"
    )
    file_id = models.ForeignKey(
        to="Files", on_delete=models.CASCADE, related_name="access_file"
    )
    access_type_id = models.ForeignKey(
        to="AccessType", on_delete=models.CASCADE, related_name="type"
    )
...
class Files(models.Model):
    user_id = models.ForeignKey(
        to="User", on_delete=models.CASCADE, related_name="file"
    )
    place_id = models.ForeignKey(
        to="Place", on_delete=models.CASCADE, related_name="file_place"
    )
    type_id = models.ForeignKey(
        to="FilesType", on_delete=models.CASCADE, related_name="file_type"
    )
    date_creation = models.DateTimeField(auto_now_add=True)
...
class Dushboards(models.Model):
    user_id = models.ForeignKey(
        to="User", on_delete=models.CASCADE, related_name="dushboard"
    )
    date_creation = models.DateTimeField(auto_now_add=True)
    date_change = models.DateTimeField(auto_now=True)
...
class Charts(models.Model):
    user_id = models.ForeignKey(
        to="User", on_delete=models.CASCADE, related_name="chart"
    )
    date_creation = models.DateTimeField(auto_now_add=True)
    date_change = models.DateTimeField(auto_now=True)
...
class Feedback(models.Model):
    user_id = models.ForeignKey(
        to="User", on_delete=models.CASCADE, related_name="feedback"
    )
    date_creation = models.DateTimeField(auto_now_add=True)
...
class Comments(models.Model):
    ...
    file_id = models.ForeignKey(
        to="Files", on_delete=models.CASCADE, related_name="comment_file"
    )
    chart_id = models.ForeignKey(
        to="Charts", on_delete=models.CASCADE, related_name="comment_chart"
    )
    dushboard_id = models.ForeignKey(
        to="Dushboards", on_delete=models.CASCADE, related_name="comment_dushboard"
    )
...
class ReadComments(models.Model):
    user_id = models.ForeignKey(
        to="User", on_delete=models.CASCADE, related_name="read"
    )
    comment_id = models.ForeignKey(
        to="Comments", on_delete=models.CASCADE, related_name="read_comment"
    )
