# Generated by Django 4.2.1 on 2024-03-27 05:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("driver", models.CharField(blank=True, max_length=35, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "publish",
                    models.CharField(
                        choices=[(0, "no"), (1, "yes")], default=0, max_length=1
                    ),
                ),
                (
                    "files_type",
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("CO", "Community"), ("MY", "My Files")],
                        default="MY",
                        max_length=2,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="comment_dashboard",
                to="users.dashboard",
            ),
        ),
        migrations.AddField(
